...
class AVWGCN(nn.Module):
    ...
    def forward(self, x, node_embeddings):
        ...
        bias = torch.matmul(node_embeddings, self.bias_pool)    #（N， embed_dim）(embed_dim, dim_out, 12)   # N, dim_out, t
...
class AGCRNCell(nn.Module):
    ...
    def forward(self, x, state, node_embeddings):
        ...
        z, r = torch.split(z_r, self.hidden_dim, dim=-1) # 各自 (B, N, hidden_dim)
